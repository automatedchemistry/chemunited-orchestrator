...
- `src/chemunited/qt/shared/resources/resources_rc.qrc`
- Generated Python module: `src/chemunited/qt/shared/resources/resources_rc.py`

When you add a new figure, icon, or stylesheet, the usual workflow is:

1. Put the file in the correct folder under `src/chemunited/qt/shared/resources/`.
...
```powershell
pyrcc5 src\chemunited\qt\shared\resources\resources_rc.qrc -o src\chemunited\qt\shared\resources\resources_rc.py
```
