...
The `chemunited.qt.protocols.workflows` package is the visual authoring layer for protocol workflows in the Qt setup window.
...
The workflows editor is mounted into the setup UI from `src/chemunited/qt/setup.py`.
